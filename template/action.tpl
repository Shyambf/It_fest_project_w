    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
          <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-900">Action</h1>
          </div>
        </header>
        <main>
                ...
                <div class="flex justify-center">
                    <div class="mb-3 xl:w-96">
                      <form action="/action" method="post">
                        <label for="exampleFormControlInput1" class="form-label inline-block mb-2 text-white-700">Please enter the code</label>
                        <input type="text" name="code" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                          id="exampleFormControlInput1"
                          placeholder="Code"
                        />
                        <input class="w-full mt-2.5 px-6 py-1.5 bg-gray-200 text-gray-700 font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-300 hover:shadow-lg focus:bg-gray-300 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-400 active:shadow-lg transition duration-150 ease-in-out" value="Send" type="submit"/>
                      </form>
                      </div>
                  </div>
              </div>
