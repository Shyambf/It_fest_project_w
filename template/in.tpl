              ...
              <div class="flex items-center">
                ...
                <div class="hidden md:block">
                  <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="/in" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page" >People in the building</a>
                  </div>
                </div>
              </div>
              <div class="hidden md:block">
                ...
                <table class="table-auto border-separate border border-slate-500 ...">
                  <thead>
                    <tr>
                      ...
                      <th class="w-7/12 border border-slate-600 ...">Full name</th>
                      <th class="w-full border border-slate-600 ...">Time</th>
                    </tr>
                  </thead>  
                  <tbody>
                    %for index, i in enumerate(user[::-1]):
                        <tr>
