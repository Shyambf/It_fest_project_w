        ...
        <nav class="bg-gray-800">
              ...
              <div class="flex items-center">
                ...
                <div class="hidden md:block">
                  <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="/log" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">History</a>
                    ...
                    <a href="/registration" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium>Registration">Registration</a>
          ...
          <div class="md:hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
              <a href="#" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">History</a>
                ...
                <table class="table-auto border-separate border border-slate-500 ...">
                  <thead>
                    <tr>
                      ...
                      <th class="w-3/12 border border-slate-600 ...">Date</th>
                      <th class="w-6/12 border border-slate-600 ...">Full name</th>
                      <th class="w-3/12 border border-slate-600 ...">Time</th>
                      <th class="w-screen border border-slate-600 ...">Action</th>
                    </tr>
                  </thead>  
                  <tbody>
                    %for index, i in enumerate(logs[::-1]):
                        <tr>
                          <td class="border border-slate-700 ...">{{len(logs) - index}}</td>
